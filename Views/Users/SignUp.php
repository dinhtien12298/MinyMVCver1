<div class="login-container signup-container">
    <div class="login-form">
        <div class="close-form"><i class="fas fa-times"></i></div>
        <form method="post">
            ...
            <div class="main-form">
                <div class="input-container">
                    ...
                    <input class="confirm-password-input" type="password" name="confirm-password" placeholder="Nhập lại mật khảu" required>
                ...
                <div class="signup-messages f-regular-17"></div>
                <button class="f-bold-15 signup-user">Đăng ký</button>
            </div>
            <div class="footer-form f-regular-14">
                <p>
                    Bạn đã có tài khoản?
                    <a class="open-other">Đăng nhập</a>
                </p>
            </div>
        </form>
    </div>
